...
INTRUDE_PUSHBULLET_ON=`load_config 'INTRUDE_PUSHBULLET_ON'`
INTRUDE_PUSHBULLET_MSG=`load_config 'INTRUDE_PUSHBULLET_MSG'`
INTRUDE_PUSHBULLET_TOKEN=`load_config 'INTRUDE_PUSHBULLET_TOKEN'`
INTRUDE_PUSHBULLET_CHANNEL=`load_config 'INTRUDE_PUSHBULLET_CHANNEL'`
...
POWERDOWN_PUSHBULLET_ON=`load_config 'POWERDOWN_PUSHBULLET_ON'`
POWERDOWN_PUSHBULLET_MSG=`load_config 'POWERDOWN_PUSHBULLET_MSG'`
POWERDOWN_PUSHBULLET_TOKEN=`load_config 'POWERDOWN_PUSHBULLET_TOKEN'`
POWERDOWN_PUSHBULLET_CHANNEL=`load_config 'POWERDOWN_PUSHBULLET_CHANNEL'`
